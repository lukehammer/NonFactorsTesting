...
namespace NonFactorsTesting.Models
{
    public class Rows
    {
        ...
        public Rows(string test1, string test2, string test3, string test4, string test5, string test6, string test7, string test8, string test9,
        ...
        public static List<Rows> CreateTestList(int numberOfRows)
        {
            ...
            for (int i = 0; i < 30; i++)
            {
                ...
                string v1 = $"Test row {value} Test Col 1";
